...
const (
	colorURL         = "https://api.weixin.qq.com/card/getcolors?access_token=%s"
	applyProtocolURL = "https://api.weixin.qq.com/card/getapplyprotocol?access_token=%s"
	createCardURL    = "https://api.weixin.qq.com/card/create?access_token=%s"
	getCardURL       = "https://api.weixin.qq.com/card/get?access_token=%s"
	batchGetURL      = "https://api.weixin.qq.com/card/batchget?access_token=%s"
